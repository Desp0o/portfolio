...
function HomeEngDark() {
    ...
    return(
    <div style={{width:'100%', height:'100vh'}} className="darkthememode">
        ...
        <nav className="navbar_dark">
            ...
            <div className="nav_right">
                <Link to='' className="navLinks links_dark_mode" onClick={()=> handleClick(homeRef)}>Home</Link>
                <Link to='' className="navLinks links_dark_mode" onClick={()=> handleClick(aboutRef)}>About</Link>
                <Link to='' className="navLinks links_dark_mode" onClick={()=> handleClick(projectRef)}>Projects</Link>
                <Link to='' className="navLinks links_dark_mode" onClick={()=> handleClick(contactRef)}>Contact</Link>
                <Link to='/darkmode/homdeDark' className="navLinks links_dark_mode">GEO</Link>
            </div>
        ...
        <div className={dashbrd} onClick={()=> toggleMenu()}>
            ...
            <div><Link to='/darkmode/homdeDark' className="navLinks links_dark_mode">GEO</Link></div>
        </div>
        ...
        <div className="about_me" >
                <h1 className="about_me_h1 darkmodetext">ABOUT ME</h1>
                <span className="underline"></span>

                <div className="about_me_inner">
                    <div className="about_me_inner_left">
                        <h2 className="darkmodetext">Get to know me!</h2>
        ...
        <div className="projects" >
            ...
            <div className="projects_inner">
                ...
                <div className="prj">
                        ...
                        <div className="prj_inner">
                            ...
                            <p className="darkmodetext">Auto import Web page, with transportation and Customs Clearnece calculator.  </p>
                ...
                <div className="prj">
                        ...
                        <div className="prj_inner">
                            ...
                            <p className="darkmodetext">3Dlab is Animation studio, famous in social networks, with its funny projects</p>
                            <span className="button_to_cont visitBTN">
                ...
                <div className="prj">
                        ...
                        <div className="prj_inner">
                            ...
                            <p className="darkmodetext">NFT project Landing page, with road map and OpenSea's account link</p>
                            <span className="button_to_cont visitBTN">
                ...
                <div className="prj">
                        ...
                        <div className="prj_inner">
                            ...
                            <p className="darkmodetext">Moto shop web page clone, with responsive navbar and links animation</p>
                            <span className="button_to_cont visitBTN">
            ...
            <span className="button_to_cont seeMore">
               <Link style={{textDecoration:'none'}} to="/projDarkEng"><span className="button_to_cont_inner seeMoteBTN" >See More Projects</span></Link>
            </span>
