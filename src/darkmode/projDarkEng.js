...
function ProjectDarkEng() {
    ...
    return(
        <div style={{width:'100%', height:'100vh'}} className="project_dark_mode">
        ...
        <nav className="navbar_dark">
            <div className="nav_left">
               ...
               <Link to="/homeEngDark" style={{textDecoration:'none', color:'unset'}}> <p className="links_dark_mode">Tornike Despotashvili</p></Link>
            </div>
        ...
        <div className="mainScreen">
            <h1 style={{textAlign:'center'}} className='darkmodetext'>Here You Are!</h1>
            ...
            <div className="projects" >
                ...
                <div className="prj">
                        ...
                        <div className="prj_inner">
                            ...
                            <p className="darkmodetext">Moto shop web page clone, with responsive design and links animation</p>
                            <span className="button_to_cont visitBTN">
                ...
                <div className="prj">
                        ...
                        <div className="prj_inner">
                            ...
                            <p className="darkmodetext">Architecutre web page clone, with responsive design and animations</p>
                            <span className="button_to_cont visitBTN">
                ...
                <div className="prj">
                        ...
                        <div className="prj_inner">
                            ...
                            <p className="darkmodetext">Chess registration form built with React JS</p>
                            <span className="button_to_cont visitBTN">
                ...
                <div className="prj">
                        ...
                        <div className="prj_inner">
                            ...
                            <p className="darkmodetext">Super light portfolio web page for Frontend Web Developer, built with React JS </p>
                            <span className="button_to_cont visitBTN">
                ...
                <div className="prj">
                        ...
                        <div className="prj_inner">
                            ...
                            <p className="darkmodetext">Auto import Android APP with transportation and Customs Clearnece calculator.</p>
                            <span className="button_to_cont visitBTN">
